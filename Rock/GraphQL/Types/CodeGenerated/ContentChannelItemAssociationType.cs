...
{
    /// <summary>
    /// ContentChannelItemAssociation GraphQL Type
    /// </summary>
    public partial class ContentChannelItemAssociation : ModelGraphType<Rock.Model.ContentChannelItemAssociation>
    {
       public ContentChannelItemAssociation(): base("ContentChannelItemAssociation")
       {
          Field<Rock.GraphQL.Types.ContentChannelItem>("ChildContentChannelItem", resolve: x => x.Source.ChildContentChannelItem);
          Field("ChildContentChannelItemId", x => x.ChildContentChannelItemId, nullable: false);
          Field<Rock.GraphQL.Types.ContentChannelItem>("ContentChannelItem", resolve: x => x.Source.ContentChannelItem);
          Field("ContentChannelItemId", x => x.ContentChannelItemId, nullable: false);
       ...
       public override Rock.Model.ContentChannelItemAssociation GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.ContentChannelItemAssociationService(context.db);
