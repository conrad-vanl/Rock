...
{
    /// <summary>
    /// WorkflowActionFormAttribute GraphQL Type
    /// </summary>
    public partial class WorkflowActionFormAttribute : ModelGraphType<Rock.Model.WorkflowActionFormAttribute>
    {
       public WorkflowActionFormAttribute(): base("WorkflowActionFormAttribute")
       {
       ...
       public override Rock.Model.WorkflowActionFormAttribute GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.WorkflowActionFormAttributeService(context.db);
