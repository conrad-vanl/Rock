...
namespace Rock.GraphQL.Types
{
    ...
    /// Auth GraphQL Type
    /// </summary>
    public partial class Auth : ModelGraphType<Rock.Model.Auth>
    {
       public Auth(): base("Auth")
       {
          Field("Action", x => x.Action, nullable: false);
          Field("AllowOrDeny", x => x.AllowOrDeny, nullable: false);
          ...
          Field("SpecialRole", x => x.SpecialRole.ConvertToInt(), nullable: false);
       ...
       public override Rock.Model.Auth GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.AuthService(context.db);
