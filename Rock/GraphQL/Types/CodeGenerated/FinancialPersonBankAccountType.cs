...
{
    /// <summary>
    /// FinancialPersonBankAccount GraphQL Type
    /// </summary>
    public partial class FinancialPersonBankAccount : ModelGraphType<Rock.Model.FinancialPersonBankAccount>
    {
       public FinancialPersonBankAccount(): base("FinancialPersonBankAccount")
       {
          Field("AccountNumberMasked", x => x.AccountNumberMasked, nullable: false);
          Field("AccountNumberSecured", x => x.AccountNumberSecured, nullable: false);
       ...
       public override Rock.Model.FinancialPersonBankAccount GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.FinancialPersonBankAccountService(context.db);
