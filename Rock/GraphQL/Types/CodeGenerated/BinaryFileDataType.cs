...
{
    /// <summary>
    /// BinaryFileData GraphQL Type
    /// </summary>
    public partial class BinaryFileData : ModelGraphType<Rock.Model.BinaryFileData>
    {
       public BinaryFileData(): base("BinaryFileData")
       {
       ...
       public override Rock.Model.BinaryFileData GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.BinaryFileDataService(context.db);
