...
{
    /// <summary>
    /// MetricPartition GraphQL Type
    /// </summary>
    public partial class MetricPartition : ModelGraphType<Rock.Model.MetricPartition>
    {
       ...
       public override Rock.Model.MetricPartition GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.MetricPartitionService(context.db);
