...
{
    /// <summary>
    /// PageContext GraphQL Type
    /// </summary>
    public partial class PageContext : ModelGraphType<Rock.Model.PageContext>
    {
       public PageContext(): base("PageContext")
       {
          Field("Entity", x => x.Entity, nullable: false);
          Field("ForeignGuid", x => x.ForeignGuid.ToStringSafe(), nullable: true);
          Field("ForeignKey", x => x.ForeignKey, nullable: false);
          Field("IdParameter", x => x.IdParameter, nullable: false);
          Field("IsSystem", x => x.IsSystem, nullable: false);
          Field("ModifiedAuditValuesAlreadyUpdated", x => x.ModifiedAuditValuesAlreadyUpdated, nullable: false);
          Field("PageId", x => x.PageId, nullable: false);
       ...
       public override Rock.Model.PageContext GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.PageContextService(context.db);
