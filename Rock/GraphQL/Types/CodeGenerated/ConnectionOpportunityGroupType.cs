...
{
    /// <summary>
    /// ConnectionOpportunityGroup GraphQL Type
    /// </summary>
    public partial class ConnectionOpportunityGroup : ModelGraphType<Rock.Model.ConnectionOpportunityGroup>
    {
       public ConnectionOpportunityGroup(): base("ConnectionOpportunityGroup")
       {
       ...
       public override Rock.Model.ConnectionOpportunityGroup GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.ConnectionOpportunityGroupService(context.db);
