...
{
    /// <summary>
    /// ConnectionRequestWorkflow GraphQL Type
    /// </summary>
    public partial class ConnectionRequestWorkflow : ModelGraphType<Rock.Model.ConnectionRequestWorkflow>
    {
       ...
       public override Rock.Model.ConnectionRequestWorkflow GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.ConnectionRequestWorkflowService(context.db);
