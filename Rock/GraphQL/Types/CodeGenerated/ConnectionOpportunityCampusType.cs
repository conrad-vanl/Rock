...
{
    /// <summary>
    /// ConnectionOpportunityCampus GraphQL Type
    /// </summary>
    public partial class ConnectionOpportunityCampus : ModelGraphType<Rock.Model.ConnectionOpportunityCampus>
    {
       public ConnectionOpportunityCampus(): base("ConnectionOpportunityCampus")
       {
          Field<Rock.GraphQL.Types.Campus>("Campus", resolve: x => x.Source.Campus);
          Field("CampusId", x => x.CampusId, nullable: false);
          ...
          Field<Rock.GraphQL.Types.PersonAlias>("DefaultConnectorPersonAlias", resolve: x => x.Source.DefaultConnectorPersonAlias);
          Field("DefaultConnectorPersonAliasId", x => x.DefaultConnectorPersonAliasId, nullable: true);
       ...
       public override Rock.Model.ConnectionOpportunityCampus GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.ConnectionOpportunityCampusService(context.db);
