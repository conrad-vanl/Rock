...
{
    /// <summary>
    /// RegistrationTemplateForm GraphQL Type
    /// </summary>
    public partial class RegistrationTemplateForm : ModelGraphType<Rock.Model.RegistrationTemplateForm>
    {
       public RegistrationTemplateForm(): base("RegistrationTemplateForm")
       {
          ...
          Field<ListGraphType<Rock.GraphQL.Types.RegistrationTemplateFormField>>("Fields", resolve: x => x.Source.Fields);
       ...
       public override Rock.Model.RegistrationTemplateForm GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.RegistrationTemplateFormService(context.db);
