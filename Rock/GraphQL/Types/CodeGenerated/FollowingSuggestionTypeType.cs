...
{
    /// <summary>
    /// FollowingSuggestionType GraphQL Type
    /// </summary>
    public partial class FollowingSuggestionType : ModelGraphType<Rock.Model.FollowingSuggestionType>
    {
       public FollowingSuggestionType(): base("FollowingSuggestionType")
       {
          ...
          Field("ReasonNote", x => x.ReasonNote, nullable: false);
          Field("ReminderDays", x => x.ReminderDays, nullable: true);
       ...
       public override Rock.Model.FollowingSuggestionType GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.FollowingSuggestionTypeService(context.db);
