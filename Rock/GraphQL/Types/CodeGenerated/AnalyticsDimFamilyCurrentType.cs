...
{
    /// <summary>
    /// AnalyticsDimFamilyCurrent GraphQL Type
    /// </summary>
    public partial class AnalyticsDimFamilyCurrent : ModelGraphType<Rock.Model.AnalyticsDimFamilyCurrent>
    {
       public AnalyticsDimFamilyCurrent(): base("AnalyticsDimFamilyCurrent")
       {
       ...
       public override Rock.Model.AnalyticsDimFamilyCurrent GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.AnalyticsDimFamilyCurrentService(context.db);
