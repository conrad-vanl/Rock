...
{
    /// <summary>
    /// RegistrationTemplateDiscount GraphQL Type
    /// </summary>
    public partial class RegistrationTemplateDiscount : ModelGraphType<Rock.Model.RegistrationTemplateDiscount>
    {
       ...
       public override Rock.Model.RegistrationTemplateDiscount GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.RegistrationTemplateDiscountService(context.db);
