...
{
    /// <summary>
    /// FinancialTransactionImage GraphQL Type
    /// </summary>
    public partial class FinancialTransactionImage : ModelGraphType<Rock.Model.FinancialTransactionImage>
    {
       public FinancialTransactionImage(): base("FinancialTransactionImage")
       {
          ...
          Field<Rock.GraphQL.Types.FinancialTransaction>("Transaction", resolve: x => x.Source.Transaction);
       ...
       public override Rock.Model.FinancialTransactionImage GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.FinancialTransactionImageService(context.db);
