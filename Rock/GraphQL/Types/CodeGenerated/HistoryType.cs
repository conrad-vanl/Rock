...
{
    /// <summary>
    /// History GraphQL Type
    /// </summary>
    public partial class History : ModelGraphType<Rock.Model.History>
    {
       ...
       public override Rock.Model.History GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.HistoryService(context.db);
