...
namespace Rock.GraphQL.Types
{
    ...
    /// </summary>
    public partial class FieldType : ModelGraphType<Rock.Model.FieldType>
    {
       public FieldType(): base("FieldType")
       {
       ...
       public override Rock.Model.FieldType GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.FieldTypeService(context.db);
