...
{
    /// <summary>
    /// EventCalendar GraphQL Type
    /// </summary>
    public partial class EventCalendar : ModelGraphType<Rock.Model.EventCalendar>
    {
       public EventCalendar(): base("EventCalendar")
       {
          Field<ListGraphType<Rock.GraphQL.Types.EventCalendarContentChannel>>("ContentChannels", resolve: x => x.Source.ContentChannels);
       ...
       public override Rock.Model.EventCalendar GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.EventCalendarService(context.db);
