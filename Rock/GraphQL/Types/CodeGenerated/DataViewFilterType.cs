...
{
    /// <summary>
    /// DataViewFilter GraphQL Type
    /// </summary>
    public partial class DataViewFilter : ModelGraphType<Rock.Model.DataViewFilter>
    {
       public DataViewFilter(): base("DataViewFilter")
       {
          Field<ListGraphType<Rock.GraphQL.Types.DataViewFilter>>("ChildFilters", resolve: x => x.Source.ChildFilters);
          ...
          Field("Expanded", x => x.Expanded, nullable: false);
          Field("ExpressionType", x => x.ExpressionType.ConvertToInt(), nullable: false);
          ...
          Field<Rock.GraphQL.Types.DataViewFilter>("Parent", resolve: x => x.Source.Parent);
       ...
       public override Rock.Model.DataViewFilter GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.DataViewFilterService(context.db);
