...
{
    /// <summary>
    /// ConnectionStatus GraphQL Type
    /// </summary>
    public partial class ConnectionStatus : ModelGraphType<Rock.Model.ConnectionStatus>
    {
       public ConnectionStatus(): base("ConnectionStatus")
       {
          ...
          Field("IsCritical", x => x.IsCritical, nullable: false);
          Field("IsDefault", x => x.IsDefault, nullable: false);
       ...
       public override Rock.Model.ConnectionStatus GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.ConnectionStatusService(context.db);
