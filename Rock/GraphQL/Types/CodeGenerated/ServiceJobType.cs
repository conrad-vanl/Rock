...
{
    /// <summary>
    /// ServiceJob GraphQL Type
    /// </summary>
    public partial class ServiceJob : ModelGraphType<Rock.Model.ServiceJob>
    {
       public ServiceJob(): base("ServiceJob")
       {
       ...
       public override Rock.Model.ServiceJob GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.ServiceJobService(context.db);
