...
{
    /// <summary>
    /// BlockType GraphQL Type
    /// </summary>
    public partial class BlockType : ModelGraphType<Rock.Model.BlockType>
    {
       public BlockType(): base("BlockType")
       {
          Field<ListGraphType<Rock.GraphQL.Types.Block>>("Blocks", resolve: x => x.Source.Blocks);
          Field("Category", x => x.Category, nullable: false);
       ...
       public override Rock.Model.BlockType GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.BlockTypeService(context.db);
