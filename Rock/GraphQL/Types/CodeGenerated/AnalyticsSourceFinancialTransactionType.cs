...
{
    /// <summary>
    /// AnalyticsSourceFinancialTransaction GraphQL Type
    /// </summary>
    public partial class AnalyticsSourceFinancialTransaction : ModelGraphType<Rock.Model.AnalyticsSourceFinancialTransaction>
    {
       public AnalyticsSourceFinancialTransaction(): base("AnalyticsSourceFinancialTransaction")
       {
       ...
       public override Rock.Model.AnalyticsSourceFinancialTransaction GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.AnalyticsSourceFinancialTransactionService(context.db);
