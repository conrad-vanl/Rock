...
{
    /// <summary>
    /// EventItemOccurrenceGroupMap GraphQL Type
    /// </summary>
    public partial class EventItemOccurrenceGroupMap : ModelGraphType<Rock.Model.EventItemOccurrenceGroupMap>
    {
       ...
       public override Rock.Model.EventItemOccurrenceGroupMap GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.EventItemOccurrenceGroupMapService(context.db);
