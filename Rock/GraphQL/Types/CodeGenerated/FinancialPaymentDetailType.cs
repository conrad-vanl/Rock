...
{
    /// <summary>
    /// FinancialPaymentDetail GraphQL Type
    /// </summary>
    public partial class FinancialPaymentDetail : ModelGraphType<Rock.Model.FinancialPaymentDetail>
    {
       public FinancialPaymentDetail(): base("FinancialPaymentDetail")
       {
       ...
       public override Rock.Model.FinancialPaymentDetail GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.FinancialPaymentDetailService(context.db);
