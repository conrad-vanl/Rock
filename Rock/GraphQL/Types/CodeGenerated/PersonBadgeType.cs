...
{
    /// <summary>
    /// PersonBadge GraphQL Type
    /// </summary>
    public partial class PersonBadge : ModelGraphType<Rock.Model.PersonBadge>
    {
       public PersonBadge(): base("PersonBadge")
       {
       ...
       public override Rock.Model.PersonBadge GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.PersonBadgeService(context.db);
