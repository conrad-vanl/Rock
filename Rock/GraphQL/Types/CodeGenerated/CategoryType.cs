...
namespace Rock.GraphQL.Types
{
    ...
    /// </summary>
    public partial class Category : ModelGraphType<Rock.Model.Category>
    {
       public Category(): base("Category")
       {
          Field<ListGraphType<Rock.GraphQL.Types.Category>>("ChildCategories", resolve: x => x.Source.ChildCategories);
          ...
          Field("HighlightColor", x => x.HighlightColor, nullable: false);
          ...
          Field<Rock.GraphQL.Types.Category>("ParentCategory", resolve: x => x.Source.ParentCategory);
          Field("ParentCategoryId", x => x.ParentCategoryId, nullable: true);
       ...
       public override Rock.Model.Category GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.CategoryService(context.db);
