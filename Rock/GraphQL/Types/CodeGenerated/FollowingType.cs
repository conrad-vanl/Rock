...
{
    /// <summary>
    /// Following GraphQL Type
    /// </summary>
    public partial class Following : ModelGraphType<Rock.Model.Following>
    {
       public Following(): base("Following")
       {
       ...
       public override Rock.Model.Following GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.FollowingService(context.db);
