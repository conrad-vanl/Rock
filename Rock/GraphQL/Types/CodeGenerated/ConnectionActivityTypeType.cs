...
{
    /// <summary>
    /// ConnectionActivityType GraphQL Type
    /// </summary>
    public partial class ConnectionActivityType : ModelGraphType<Rock.Model.ConnectionActivityType>
    {
       public ConnectionActivityType(): base("ConnectionActivityType")
       {
       ...
       public override Rock.Model.ConnectionActivityType GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.ConnectionActivityTypeService(context.db);
