...
{
    /// <summary>
    /// BenevolenceRequestDocument GraphQL Type
    /// </summary>
    public partial class BenevolenceRequestDocument : ModelGraphType<Rock.Model.BenevolenceRequestDocument>
    {
       public BenevolenceRequestDocument(): base("BenevolenceRequestDocument")
       {
          ...
          Field("BinaryFileId", x => x.BinaryFileId, nullable: false);
          ...
          Field("Order", x => x.Order, nullable: true);
       ...
       public override Rock.Model.BenevolenceRequestDocument GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.BenevolenceRequestDocumentService(context.db);
