...
{
    /// <summary>
    /// PageRoute GraphQL Type
    /// </summary>
    public partial class PageRoute : ModelGraphType<Rock.Model.PageRoute>
    {
       public PageRoute(): base("PageRoute")
       {
          ...
          Field("Route", x => x.Route, nullable: false);
       ...
       public override Rock.Model.PageRoute GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.PageRouteService(context.db);
