...
{
    /// <summary>
    /// GroupScheduleExclusion GraphQL Type
    /// </summary>
    public partial class GroupScheduleExclusion : ModelGraphType<Rock.Model.GroupScheduleExclusion>
    {
       public GroupScheduleExclusion(): base("GroupScheduleExclusion")
       {
       ...
       public override Rock.Model.GroupScheduleExclusion GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.GroupScheduleExclusionService(context.db);
