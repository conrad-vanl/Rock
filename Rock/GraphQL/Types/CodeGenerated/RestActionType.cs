...
{
    /// <summary>
    /// RestAction GraphQL Type
    /// </summary>
    public partial class RestAction : ModelGraphType<Rock.Model.RestAction>
    {
       public RestAction(): base("RestAction")
       {
          Field("ApiId", x => x.ApiId, nullable: false);
          Field("ContextKey", x => x.ContextKey, nullable: false);
          Field<Rock.GraphQL.Types.RestController>("Controller", resolve: x => x.Source.Controller);
          Field("ControllerId", x => x.ControllerId, nullable: false);
          ...
          Field("Method", x => x.Method, nullable: false);
       ...
       public override Rock.Model.RestAction GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.RestActionService(context.db);
