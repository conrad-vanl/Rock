...
{
    /// <summary>
    /// SiteDomain GraphQL Type
    /// </summary>
    public partial class SiteDomain : ModelGraphType<Rock.Model.SiteDomain>
    {
       public SiteDomain(): base("SiteDomain")
       {
          Field("Domain", x => x.Domain, nullable: false);
       ...
       public override Rock.Model.SiteDomain GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.SiteDomainService(context.db);
