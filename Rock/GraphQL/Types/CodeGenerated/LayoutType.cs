...
namespace Rock.GraphQL.Types
{
    ...
    /// Layout GraphQL Type
    /// </summary>
    public partial class Layout : ModelGraphType<Rock.Model.Layout>
    {
       ...
       public override Rock.Model.Layout GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.LayoutService(context.db);
