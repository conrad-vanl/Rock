...
{
    /// <summary>
    /// EntitySetItem GraphQL Type
    /// </summary>
    public partial class EntitySetItem : ModelGraphType<Rock.Model.EntitySetItem>
    {
       public EntitySetItem(): base("EntitySetItem")
       {
          ...
          Field<Rock.GraphQL.Types.EntitySet>("EntitySet", resolve: x => x.Source.EntitySet);
          Field("EntitySetId", x => x.EntitySetId, nullable: false);
       ...
       public override Rock.Model.EntitySetItem GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.EntitySetItemService(context.db);
