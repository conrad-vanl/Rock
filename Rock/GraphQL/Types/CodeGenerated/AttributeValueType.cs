...
{
    /// <summary>
    /// AttributeValue GraphQL Type
    /// </summary>
    public partial class AttributeValue : ModelGraphType<Rock.Model.AttributeValue>
    {
       public AttributeValue(): base("AttributeValue")
       {
          ...
          Field("AttributeIsGridColumn", x => x.AttributeIsGridColumn, nullable: false);
          Field("AttributeKey", x => x.AttributeKey, nullable: false);
          Field("AttributeName", x => x.AttributeName, nullable: false);
          ...
          Field("ValueAsBoolean", x => x.ValueAsBoolean, nullable: true);
          Field("ValueAsDateTime", x => x.ValueAsDateTime, nullable: true);
          Field("ValueAsNumeric", x => x.ValueAsNumeric, nullable: true);
          Field("ValueAsPersonId", x => x.ValueAsPersonId, nullable: true);
          Field("ValueFormatted", x => x.ValueFormatted, nullable: false);
       ...
       public override Rock.Model.AttributeValue GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.AttributeValueService(context.db);
