...
{
    /// <summary>
    /// ConnectionWorkflow GraphQL Type
    /// </summary>
    public partial class ConnectionWorkflow : ModelGraphType<Rock.Model.ConnectionWorkflow>
    {
       public ConnectionWorkflow(): base("ConnectionWorkflow")
       {
          ...
          Field("ConnectionTypeId", x => x.ConnectionTypeId, nullable: true);
          ...
          Field("QualifierValue", x => x.QualifierValue, nullable: false);
          ...
          Field("WorkflowTypeId", x => x.WorkflowTypeId, nullable: true);
       ...
       public override Rock.Model.ConnectionWorkflow GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.ConnectionWorkflowService(context.db);
