...
{
    /// <summary>
    /// FinancialPledge GraphQL Type
    /// </summary>
    public partial class FinancialPledge : ModelGraphType<Rock.Model.FinancialPledge>
    {
       public FinancialPledge(): base("FinancialPledge")
       {
          ...
          Field<Rock.GraphQL.Types.DefinedValue>("PledgeFrequencyValue", resolve: x => x.Source.PledgeFrequencyValue);
          Field("PledgeFrequencyValueId", x => x.PledgeFrequencyValueId, nullable: true);
       ...
       public override Rock.Model.FinancialPledge GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.FinancialPledgeService(context.db);
