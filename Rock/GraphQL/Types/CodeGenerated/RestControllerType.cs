...
{
    /// <summary>
    /// RestController GraphQL Type
    /// </summary>
    public partial class RestController : ModelGraphType<Rock.Model.RestController>
    {
       public RestController(): base("RestController")
       {
          Field<ListGraphType<Rock.GraphQL.Types.RestAction>>("Actions", resolve: x => x.Source.Actions);
          Field("ClassName", x => x.ClassName, nullable: false);
       ...
       public override Rock.Model.RestController GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.RestControllerService(context.db);
