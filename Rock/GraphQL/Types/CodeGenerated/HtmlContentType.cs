...
{
    /// <summary>
    /// HtmlContent GraphQL Type
    /// </summary>
    public partial class HtmlContent : ModelGraphType<Rock.Model.HtmlContent>
    {
       public HtmlContent(): base("HtmlContent")
       {
          ...
          Field<Rock.GraphQL.Types.Block>("Block", resolve: x => x.Source.Block);
          Field("BlockId", x => x.BlockId, nullable: false);
          ...
          Field("EntityValue", x => x.EntityValue, nullable: false);
          ...
          Field("Version", x => x.Version, nullable: false);
       ...
       public override Rock.Model.HtmlContent GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.HtmlContentService(context.db);
