...
{
    /// <summary>
    /// PersonPreviousName GraphQL Type
    /// </summary>
    public partial class PersonPreviousName : ModelGraphType<Rock.Model.PersonPreviousName>
    {
       public PersonPreviousName(): base("PersonPreviousName")
       {
       ...
       public override Rock.Model.PersonPreviousName GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.PersonPreviousNameService(context.db);
