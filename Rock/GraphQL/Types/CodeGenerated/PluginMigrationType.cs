...
{
    /// <summary>
    /// PluginMigration GraphQL Type
    /// </summary>
    public partial class PluginMigration : ModelGraphType<Rock.Model.PluginMigration>
    {
       public PluginMigration(): base("PluginMigration")
       {
          ...
          Field("MigrationName", x => x.MigrationName, nullable: false);
          Field("MigrationNumber", x => x.MigrationNumber, nullable: false);
          ...
          Field("PluginAssemblyName", x => x.PluginAssemblyName, nullable: false);
       ...
       public override Rock.Model.PluginMigration GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.PluginMigrationService(context.db);
