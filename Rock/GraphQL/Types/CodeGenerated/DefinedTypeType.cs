...
{
    /// <summary>
    /// DefinedType GraphQL Type
    /// </summary>
    public partial class DefinedType : ModelGraphType<Rock.Model.DefinedType>
    {
       public DefinedType(): base("DefinedType")
       {
          ...
          Field<ListGraphType<Rock.GraphQL.Types.DefinedValue>>("DefinedValues", resolve: x => x.Source.DefinedValues);
          ...
          Field("FieldTypeId", x => x.FieldTypeId, nullable: true);
          Field("ForeignGuid", x => x.ForeignGuid.ToStringSafe(), nullable: true);
          Field("ForeignKey", x => x.ForeignKey, nullable: false);
          Field("HelpText", x => x.HelpText, nullable: false);
       ...
       public override Rock.Model.DefinedType GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.DefinedTypeService(context.db);
