...
{
    /// <summary>
    /// AnalyticsDimFamilyHeadOfHousehold GraphQL Type
    /// </summary>
    public partial class AnalyticsDimFamilyHeadOfHousehold : ModelGraphType<Rock.Model.AnalyticsDimFamilyHeadOfHousehold>
    {
       public AnalyticsDimFamilyHeadOfHousehold(): base("AnalyticsDimFamilyHeadOfHousehold")
       {
       ...
       public override Rock.Model.AnalyticsDimFamilyHeadOfHousehold GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.AnalyticsDimFamilyHeadOfHouseholdService(context.db);
