...
{
    /// <summary>
    /// InteractionComponent GraphQL Type
    /// </summary>
    public partial class InteractionComponent : ModelGraphType<Rock.Model.InteractionComponent>
    {
       public InteractionComponent(): base("InteractionComponent")
       {
          Field<Rock.GraphQL.Types.InteractionChannel>("Channel", resolve: x => x.Source.Channel);
          Field("ChannelId", x => x.ChannelId, nullable: false);
          Field("ComponentData", x => x.ComponentData, nullable: false);
       ...
       public override Rock.Model.InteractionComponent GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.InteractionComponentService(context.db);
