...
{
    /// <summary>
    /// MergeTemplate GraphQL Type
    /// </summary>
    public partial class MergeTemplate : ModelGraphType<Rock.Model.MergeTemplate>
    {
       public MergeTemplate(): base("MergeTemplate")
       {
          ...
          Field<Rock.GraphQL.Types.EntityType>("MergeTemplateTypeEntityType", resolve: x => x.Source.MergeTemplateTypeEntityType);
          Field("MergeTemplateTypeEntityTypeId", x => x.MergeTemplateTypeEntityTypeId, nullable: false);
          ...
          Field<Rock.GraphQL.Types.BinaryFile>("TemplateBinaryFile", resolve: x => x.Source.TemplateBinaryFile);
          Field("TemplateBinaryFileId", x => x.TemplateBinaryFileId, nullable: false);
       ...
       public override Rock.Model.MergeTemplate GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.MergeTemplateService(context.db);
