...
{
    /// <summary>
    /// EventCalendarItem GraphQL Type
    /// </summary>
    public partial class EventCalendarItem : ModelGraphType<Rock.Model.EventCalendarItem>
    {
       public EventCalendarItem(): base("EventCalendarItem")
       {
       ...
       public override Rock.Model.EventCalendarItem GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.EventCalendarItemService(context.db);
