...
namespace Rock.GraphQL.Types
{
    ...
    /// </summary>
    public partial class Attribute : ModelGraphType<Rock.Model.Attribute>
    {
       public Attribute(): base("Attribute")
       {
          Field("AllowSearch", x => x.AllowSearch, nullable: false);
          Field<ListGraphType<Rock.GraphQL.Types.AttributeQualifier>>("AttributeQualifiers", resolve: x => x.Source.AttributeQualifiers);
          Field<ListGraphType<Rock.GraphQL.Types.Category>>("Categories", resolve: x => x.Source.Categories);
          ...
          Field("DefaultValue", x => x.DefaultValue, nullable: false);
          ...
          Field<Rock.GraphQL.Types.FieldType>("FieldType", resolve: x => x.Source.FieldType);
          Field("FieldTypeId", x => x.FieldTypeId, nullable: false);
          Field("ForeignGuid", x => x.ForeignGuid.ToStringSafe(), nullable: true);
          Field("ForeignKey", x => x.ForeignKey, nullable: false);
          Field("IconCssClass", x => x.IconCssClass, nullable: false);
          Field("IsAnalytic", x => x.IsAnalytic, nullable: false);
          Field("IsAnalyticHistory", x => x.IsAnalyticHistory, nullable: false);
          Field("IsGridColumn", x => x.IsGridColumn, nullable: false);
          Field("IsIndexEnabled", x => x.IsIndexEnabled, nullable: false);
          Field("IsMultiValue", x => x.IsMultiValue, nullable: false);
       ...
       public override Rock.Model.Attribute GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.AttributeService(context.db);
