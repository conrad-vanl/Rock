...
{
    /// <summary>
    /// ConnectionRequestActivity GraphQL Type
    /// </summary>
    public partial class ConnectionRequestActivity : ModelGraphType<Rock.Model.ConnectionRequestActivity>
    {
       public ConnectionRequestActivity(): base("ConnectionRequestActivity")
       {
          Field<Rock.GraphQL.Types.ConnectionActivityType>("ConnectionActivityType", resolve: x => x.Source.ConnectionActivityType);
          Field("ConnectionActivityTypeId", x => x.ConnectionActivityTypeId, nullable: false);
          Field<Rock.GraphQL.Types.ConnectionOpportunity>("ConnectionOpportunity", resolve: x => x.Source.ConnectionOpportunity);
          Field("ConnectionOpportunityId", x => x.ConnectionOpportunityId, nullable: true);
       ...
       public override Rock.Model.ConnectionRequestActivity GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.ConnectionRequestActivityService(context.db);
