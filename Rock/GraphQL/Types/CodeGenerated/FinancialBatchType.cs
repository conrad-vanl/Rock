...
{
    /// <summary>
    /// FinancialBatch GraphQL Type
    /// </summary>
    public partial class FinancialBatch : ModelGraphType<Rock.Model.FinancialBatch>
    {
       public FinancialBatch(): base("FinancialBatch")
       {
       ...
       public override Rock.Model.FinancialBatch GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.FinancialBatchService(context.db);
