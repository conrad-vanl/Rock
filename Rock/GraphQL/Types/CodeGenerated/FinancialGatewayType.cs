...
{
    /// <summary>
    /// FinancialGateway GraphQL Type
    /// </summary>
    public partial class FinancialGateway : ModelGraphType<Rock.Model.FinancialGateway>
    {
       public FinancialGateway(): base("FinancialGateway")
       {
          Field("BatchTimeOffsetTicks", x => x.BatchTimeOffsetTicks, nullable: false);
       ...
       public override Rock.Model.FinancialGateway GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.FinancialGatewayService(context.db);
