...
{
    /// <summary>
    /// WorkflowTrigger GraphQL Type
    /// </summary>
    public partial class WorkflowTrigger : ModelGraphType<Rock.Model.WorkflowTrigger>
    {
       public WorkflowTrigger(): base("WorkflowTrigger")
       {
          ...
          Field("EntityTypeQualifierValuePrevious", x => x.EntityTypeQualifierValuePrevious, nullable: false);
       ...
       public override Rock.Model.WorkflowTrigger GetById(int id, GraphQLContext context)
       {
           var service = new Rock.Model.WorkflowTriggerService(context.db);
